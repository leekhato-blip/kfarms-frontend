                  ...
                  {items.map((item) => (
                    ...
                    >
                      ...
                      <td className="flex items-center justify-center gap-2 py-2 px-3">
                        ...
                        <button
                          onClick={() => askPermanentDelete(item)}
      ...
      <ConfirmModal
        ...
        message={
          confirm.action === "restore"
            ? `Restore "${confirm.item?.itemName}" back to sales?`
            : `This will permanently delete "${confirm.item?.itemName}". This action cannot be undone.`
        }
        confirmText={
