      ...
      <div className="font-body">
        ...
        <div className="animate-fadeIn flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-accent-primary text-darkText dark:bg-accent-primary dark:text-darkText px-4 py-2 rounded-lg hover:bg-primary/30 transition font-body"
          >
            <Download size={18} />
            Export
          </button>
