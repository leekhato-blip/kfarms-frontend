...
export default function FarmerGuideCard({
  ...
  return (
    <section
      className={`relative overflow-hidden rounded-2xl border border-sky-200/60 bg-white/75 p-4 shadow-soft dark:border-sky-500/20 dark:bg-[#081427]/80 ${className}`}
      aria-label={title}
    >
      ...
      <div className="relative">
        ...
        {tip ? (
          <div className="mt-4 flex items-start gap-2 rounded-xl border border-emerald-200/70 bg-emerald-50/70 px-3 py-3 text-sm text-emerald-900 dark:border-emerald-400/20 dark:bg-emerald-500/10 dark:text-emerald-100">
