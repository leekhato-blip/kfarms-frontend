...
const BASE =
  "inline-flex min-h-[1.85rem] items-center justify-center whitespace-nowrap rounded-full border px-3 py-1 text-[11px] font-semibold leading-none tracking-[0.02em] transition-shadow duration-200";
...
const ROLE = {
  OWNER:
    "border-amber-300/80 bg-amber-100 text-amber-900 shadow-[0_8px_18px_rgba(245,158,11,0.12)] dark:border-amber-400/45 dark:bg-amber-500/16 dark:text-amber-100 dark:shadow-[0_0_0_1px_rgba(245,158,11,0.22),0_0_14px_rgba(245,158,11,0.1)]",
  ADMIN:
